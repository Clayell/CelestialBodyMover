...
namespace CelestialBodyMover
{
    ...
    //            double x = Vector3d.Dot(pos, __instance.OrbitFrame.X);
    //            double y = Vector3d.Dot(pos, __instance.OrbitFrame.Y);
    //            __instance.trueAnomaly = Math.Atan2(y, x);
    //            __instance.eccentricAnomaly = __instance.GetEccentricAnomaly(__instance.trueAnomaly);
    //            __instance.meanAnomaly = __instance.GetMeanAnomaly(__instance.eccentricAnomaly);
    //            __instance.meanAnomalyAtEpoch = __instance.meanAnomaly;
    //            __instance.ObT = __instance.meanAnomaly / __instance.meanMotion;
    //            __instance.ObTAtEpoch = __instance.ObT;
    //            */
    ...
    //    [HarmonyPatch(nameof(Orbit.Init))]
    //    [HarmonyPrefix]
    //    public static bool Prefix_Init(ref Orbit __instance)
    //    {
    //        //Util.Log($"isActive: {CelestialBodyMover.Instance.isActive}");
    //        if (CelestialBodyMover.Instance.isActive)
    //        {
